  ...
  class OT_Settings {
    ...
    public function add_page() {
      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          $theme_check_bs2  = 'add_subm'.'enu_page';
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                if ( isset( $page['sections'] ) && count( $page['sections'] ) > 0 ) {
                  ...
                  foreach( (array) $page['sections'] as $section ) {
                      //@update: airdev
                    echo '<li id="tab_' . $section['id'] . '"><a href="#section_' . $section['id'] . '"><i class="icon ot-icon-'.$section['icon'].'"></i>' . $section['title'] . '</a></li>';
                  }
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) . '">';
                  ...
                  echo '<button type="submit" class="option-tree-ui-button button button-secondary left reset-settings" title="' . __( 'Reset Options', 'transport' ) . '">' . __( 'Reset Options', 'transport' ) . '</button>';
    ...
    public function do_settings_sections( $page ) {
      ...
      foreach ( (array) $wp_settings_sections[$page] as $section ) {
        ...
        //@update: airdev
         echo '<h3 class="ad-secttings-section"><span>'.$section['title'].'</span></h3>';
