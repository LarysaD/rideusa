                           ...
                           <form action="careersForm.php" method="POST">
                               ...
                               <div class="field">
                                   <div class="col-md-3 nopad"> 
                                    ...
                                    <div class="col-md-9">
                                        <div class="col-md-3 col-xs-12 nopad selectBoxes"> 
                                           <select class="date-year" id="dateYear" name="dateYear"><option value="">Year</option><option value="2016" selected="selected">2016</option><option value="2017">2017</option><option value="2018">2018</option> </select>        
                                        </div>
                                         <div class="col-md-3 col-xs-12 nopad selectBoxes"> 
                                         ...
                                         <div class="col-md-3 col-xs-12 nopad selectBoxes last"> 
                               ...
                               <div class="field">
                                    <div class="col-md-3 nopad"> 
                                     ...
                                     <div class="col-md-9">
                                         <div class="col-md-3 nopad selectBoxes"> 
                                        ...
                                        <div class="col-md-3 nopad selectBoxes"> 
                                         ...
                                         <div class="col-md-3 nopad selectBoxes last"> 
