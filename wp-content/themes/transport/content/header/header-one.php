<?php
/**
 * Transport - header one template part
 * 
 * @package transport
...
?><header id="header" class="header transport-page-settings">
    ...
    <div class="primary-header">
        <div class="container">
			...
			?>
    		    <div class="mail">
    			<img src="<?php echo esc_url(TRANSPORT_THEME_URL . '/assets/images/icon-mail.png'); ?>" alt="" />
    			<span><?php echo ($email_label_text) ? $email_label_text : esc_html__('Email us at :', 'transport'); ?> <a class="email-us" href="mailto:<?php echo esc_attr($transport_email); ?>"><?php echo esc_attr($transport_email); ?></a></span> 
    		    </div>
		    <?php endif; ?>
                </div>
                <div class="col-xs-12 col-sm-6">
			...
			?><a href="<?php echo (!empty($request_quote_page_url)) ? esc_url($request_quote_page_url) : 'javascript: void(0);'; ?>" class="request"><?php echo ($request_quote_label_text) ? esc_html($request_quote_label_text) : esc_html__('request a quote', 'transport'); ?></a><?php
