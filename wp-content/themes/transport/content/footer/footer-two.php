<?php
/**
 * Transport - footer two template part
 * 
 * @package transport
 ...
 * 
 */
$footer_layout = ot_get_option('transport_2footer');
$class = '';
if ($footer_layout == 'footer_2') {
    $class = 'transport-page-settings-two';
}
?>
<footer class="<?php echo esc_attr($class); ?>" id="footer">
