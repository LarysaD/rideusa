...
echo sprintf( __( 'The order #%d from %s has been cancelled. The order was as follows:', 'transport' ), $order->id, $order->get_formatted_billing_full_name() ) . "\n\n";
...
echo "\n" . sprintf( __( 'View order: %s', 'transport'), admin_url( 'post.php?post=' . $order->id . '&action=edit' ) ) . "\n";
