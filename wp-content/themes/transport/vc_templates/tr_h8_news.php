            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php if(!empty($buttion_title)):?><a href="<?php echo esc_html($buttion_url);?>" class="show-all"><?php echo esc_html($buttion_title);?></a><?php endif;?>
	                          ...
	                          <div class="col-xs-12 col-sm-6 col-md-6">
	                            <div class="slides-tab zoom clearfix">
	                               <?php $thumbnail_id = get_post_thumbnail_id(); 
	                                      if($thumbnail_id): ?>
	                                <figure>
	                                    <a href="<?php the_permalink(); ?>"><img src="<?php echo apply_filters('transport_image_resize', wp_get_attachment_url($thumbnail_id), '185', '197'); ?>" alt="<?php the_title(); ?>" /></a>
	                                </figure>
	                                <?php endif; ?>
...
<?php
echo $this->endBlockComment('tr_h8_news');
