...
add_action( 'vc_before_init', 'tr_news_layout_one' );

function tr_news_layout_one(){
vc_map(array( 
    "name" => __("Transport News", 'transport'),
    "base" => "tr_news_layout_one",
    "class" => "",
...
class WPBakeryShortCode_tr_news_layout_one extends WPBakeryShortCode { }