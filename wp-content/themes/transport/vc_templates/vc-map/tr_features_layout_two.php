...
add_action( 'vc_before_init', 'tr_features_layout_two' );

function tr_features_layout_two(){
vc_map(array( 
    "name" => __("Transport Features Layout Two", 'transport'),
    "base" => "tr_features_layout_two",
    "class" => "",
    "icon" => "icon-wpb-vc_extend",
    "category" => 'Content',
    "description" => __("Transport Features Layout Two.", "transport"), 
    "params" => array(
         array(
            "type" => "textfield",
            "holder" => "",
...
class WPBakeryShortCode_tr_features_layout_two extends WPBakeryShortCode { } 