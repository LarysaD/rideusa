 ...
 */
add_action( 'vc_before_init', 'tr_h8_testimonial' );

function tr_h8_testimonial() {
vc_map(array( 
    "name" => __("Transport Testimonial h8", 'transport'),
    "base" => "tr_h8_testimonial",
    "class" => "",
...
class WPBakeryShortCode_tr_h8_testimonial extends WPBakeryShortCode { }
