...
add_action( 'vc_before_init', 'tr_services_layout_three' );

function tr_services_layout_three(){
vc_map(array( 
    "name" => __("Transport Services Carousel Three", 'transport'),
    "base" => "tr_services_layout_three",
    "class" => "",
    "icon" => "icon-wpb-vc_extend",
    "category" => 'Content',
    "description" => __("Transport Services Carousel Three", "transport"),
    "params" => array(
         array(
            "type" => "textfield",
            "holder" => "",
...
class WPBakeryShortCode_tr_services_layout_three extends WPBakeryShortCode { }