...
add_action('vc_before_init', 'tr_services_layout_five');

function tr_services_layout_five() {
    ...
    vc_map(array(
        "name" => __("Transport Services Layout Five", 'transport'),
        "base" => "tr_services_layout_five",
        "class" => "",
        "icon" => "icon-wpb-vc_extend",
        "category" => 'Content',
        "description" => __("Transport Services Layout Five", "transport"),
        "params" => array(
            array(
                "type" => "textfield",
                "holder" => "",
...
class WPBakeryShortCode_tr_services_layout_five extends WPBakeryShortCode {
